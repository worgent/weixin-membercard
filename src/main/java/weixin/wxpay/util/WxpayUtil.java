...
public class WxpayUtil {
	...
	//private static String appid = "wxd52a218ec4c652c4";
	//private static String appsecret = "";
	//private static String partner = "1267980701";
	//这个参数partnerkey是在商户后台配置的一个32位的key,微信商户平台-账户设置-安全设置-api安全
	//private static String partnerkey = "iwpoohe2xiao1973iwpoohe2xiao1973";
	//微信支付成功后通知地址 必须要求80端口并且地址不能带参数
	//private static String notifyurl = "http://iwpoo.tunnel.mobi/pay/testcharge/1267980701/notify.do";																	 // Key
	...
	public static void main(String[] args) {
		...
		String openId = "oHo1mtzPRw1fFCt_d8pLgQtcdr04";
	...
	public static String getCodeurl(WxPayDto tpWxPayDto){
		...
		reqHandler.init(appid, "", tpWxPayDto.getPartnerKey());
	...
	public static String getPackage(WxPayDto tpWxPayDto) {
		...
		log.debug("获取到的预支付ID：" + prepay_id);
		log.info("wxpay,unifiedorder,"+prepay_id+","+xml);
		...
		log.debug("V3 jsApi package:" + finaPackage);
		return finaPackage;
	}

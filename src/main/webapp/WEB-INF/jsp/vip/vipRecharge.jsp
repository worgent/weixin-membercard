...
<html>
  ...
  <div class="content">
            <div class="box order">
                <span>订单号: ${vipRechargeOrder.outTradeNo}</span>
            </div>
            <div class="box sum">
                <span>共计金额￥${vipRechargeOrder.fee/100}</span>
            </div>
            <div class="box time">
                <span>下单时间: ${vipRechargeOrder.createTime}</span>
            </div>

            <input type="button" id="getBrandWCPayRequest" value="确认支付" onclick="callpay()">
        </div>

...
<head>
    ...
    <script type="text/javascript" src="/lib/js/aSelect.js"></script>
    <script type="text/javascript" src="/lib/js/aLocation.js"></script>
    <script type="text/javascript" src="/lib/js/checked.js"></script>
</head>
